    ...
    <section className="rounded-md border border-border bg-background/55 p-4">
      ...
      <div className="mt-3 grid gap-2">
        {sortedSections.map((section) => (
          <button
            className="grid grid-cols-[minmax(0,1fr)_auto] items-start gap-x-3 gap-y-1 rounded-md border border-border bg-surface/70 px-3 py-2 text-left transition hover:border-primary/45 hover:bg-surface-raised focus-visible:outline-2 focus-visible:outline-solid focus-visible:outline-primary"
            key={section.id}
